...
class Interfaz(tk.Tk):
    ...
    def crear_layout(self):
        ...
        # Filas: 0 = tabla periódica, 1 = lewis, 2 = entrada, 3 = resultado
        self.grid_rowconfigure(0, weight=1) # Fila superior (Tabla)
        self.grid_rowconfigure(1, weight=1) # Fila Lewis (nuevo)
        self.grid_rowconfigure(2, weight=0) # Fila media (Entrada)
        self.grid_rowconfigure(3, weight=1) # Fila inferior (Resultado)
        ...
        self.frame_top.grid_columnconfigure(0, weight=0) # Fija el ancho del panel de info
        self.frame_top.grid_columnconfigure(1, weight=1) # Permite que la tabla ocupe el resto
        ...
        self.frame_info = tk.Label(self.frame_top, text="Clic en un elemento\npara ver detalles.", 
                                 ...
                                 font=('Helvetica', 10), anchor='nw', width=25, height=4, 
                                 padx=5, pady=5)
        ...
        self.tabla_periodica.grid(row=0, column=1, sticky="nsew", padx=10, pady=10) 

        # --- NUEVO FRAME PARA ESTRUCTURA DE LEWIS (Fila 1) ---
        self.frame_lewis = tk.Frame(self, bg='#DDE3E8', padx=10, pady=10)
        self.frame_lewis.grid(row=1, column=0, sticky="nsew", padx=5, pady=5)

        # Configuración de columnas y filas internas
        self.frame_lewis.grid_columnconfigure(0, weight=1)
        self.frame_lewis.grid_columnconfigure(1, weight=1)
        ...
        # --- Frame donde irá el modelo 3D (PyVista) ---
        self.frame_3d = tk.Frame(self.frame_lewis, bg="black", width=400, height=300)
        self.frame_3d.grid(row=1, column=1, sticky="nsew", padx=5, pady=5)

        # --- Frame de Entrada de Ecuación (Fila 2) ---
        self.frame_input = tk.Frame(self, bg='#B0BEC5', padx=10, pady=10)
        self.frame_input.grid(row=2, column=0, sticky="ew", padx=5, pady=5)
        ...
        # Cada vez que la variable cambie ('w'), llama a convertir_a_subindices
        ...
        # --- Frame de Resultado (Fila 3) ---
        self.frame_bottom = tk.Frame(self, bg='#ECEFF1', padx=10, pady=10)
        self.frame_bottom.grid(row=3, column=0, sticky="nsew", padx=5, pady=5)
        ...
        self.output_text = scrolledtext.ScrolledText(self.frame_bottom, wrap=tk.WORD, height=15, font=('Consolas', 11), bd=2, relief=tk.SUNKEN)
